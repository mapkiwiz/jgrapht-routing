...
public abstract class AbstractHsqlDbTest {
	...
	public void setUp() throws IOException {
		...
		String nodeFilename = getClass().getClassLoader().getResource("large.nodes.tsv.gz").getFile();
		String edgeFilename = getClass().getClassLoader().getResource("large.edges.tsv.gz").getFile();
